 ...
 String _currentLang;
  ...
  Future<String> getTerms() async {
   ...
   Future<String> getTerms1() async {
     final response =
     await _apiProvider.get(Urls.TERMS_URL1 +"?api_lang=$_currentLang");
     String terms = '';
     if (response['response'] == '1') {
       terms = response['messages'];
     }
   ...
   Future<String> getTerms2() async {
     final response =
     await _apiProvider.get(Urls.TERMS_URL2 +"?api_lang=$_currentLang");
     String terms = '';
     if (response['response'] == '1') {
       terms = response['messages'];
     }
   ...
   Future<String> getNote() async {
     ...
     String terms = '';
     if (response['response'] == '1') {
       terms = response['setting_note'];
     }
     return terms;
   }

   Future<String> getClose() async {
     final response =
     await _apiProvider.get(Urls.Social +"?api_lang=$_currentLang");
     String terms = '';
     if (response['response'] == '1') {
       terms = response['setting_close'];
     }
     return terms;
   }

   Future<String> getCloseMsg() async {
     final response =
     await _apiProvider.get(Urls.Social +"?api_lang=$_currentLang");
     String terms = '';
     if (response['response'] == '1') {
       terms = response['setting_close_msg'];
     }
     return terms;
   }
