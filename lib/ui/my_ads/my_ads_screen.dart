...
import 'package:tnazul/ui/my_ads/widgets/my_ad_item.dart';
...
import 'package:flutter/material.dart';
import 'package:flutter_spinkit/flutter_spinkit.dart';
import 'package:tnazul/custom_widgets/ad_item/ad_item1.dart';
import 'package:tnazul/custom_widgets/no_data/no_data.dart';
import 'package:tnazul/custom_widgets/safe_area/page_container.dart';
import 'package:tnazul/locale/app_localizations.dart';
               ...
               IconButton(
                 ...
                 onPressed: (){
                   ...
                   if(_authProvider.currentUser!=null) {
                     ...
                     Commons.showToast(context, message: _homeProvider.currentLang=="ar"?"يجب عليك تسجيل الدخول اولا ":"You must login before");
                     Navigator.push(
                         context,
                         MaterialPageRoute(
